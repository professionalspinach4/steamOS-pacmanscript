    ...
    echo "-----------------------------------------------------"
        ...
        case $name in
            ...
            y)
                ...
                echo ""
                echo "-----------------------------------------------------"
                echo "step one: setting a password"
                echo "-----------------------------------------------------"
                echo ""
                read -p "press enter"
                #sets a password for the deck so sudo can be used
                passwd &&  read -p "press enter to continue"
                echo ""
                echo "-----------------------------------------------------"
                echo "step two: Disable read only mode"
                echo "-----------------------------------------------------"
                echo ""
                read -p "press enter"
                ...
                echo ""
                echo "-----------------------------------------------------"
                echo "step 3: initialize the pacman keyring"
                echo "-----------------------------------------------------"
                echo ""
                ...
                echo ""
                echo "-----------------------------------------------------"
                echo "step four: populate the required keys"
                echo "-----------------------------------------------------"
                echo ""
